    ...
    */
    ...
    'connections' => [
        ...
        'voyageconn' => [
            ...
            'password'  => env('EC_VOYAGE_DB_PASSWORD', '!!Voyage2020%%'),
            'charset'   => 'utf8',
            'collation' => 'utf8_unicode_ci',
            'prefix'    => '',
            'strict'    => false,
        ...
        'islandconn' => [
            'driver'    => 'mysql',
            'host'      => env('EC_ISLANDS_DB_HOST', '172.105.71.247'),
            'database'  => env('EC_ISLANDS_DB_DATABASE', 'EmporiumIslands'),
            'username'  => env('EC_ISLANDS_DB_USERNAME', 'islands'),
            'password'  => env('EC_ISLANDS_DB_PASSWORD', '!!Islands2020%%'),
            'charset'   => 'utf8',
            'collation' => 'utf8_unicode_ci',
            'prefix'    => '',
            'strict'    => false,
