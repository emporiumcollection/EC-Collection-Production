...
Route::get('/config-cache-clear', function(){
	...
	\Artisan::call('available-hotel-location');
	Cache::flush();
	dd("Cache is cleared");
});
...
Route::get('matchdestination', 'MatchController@machDestination');
Route::post('savemathhotels', 'MatchController@saveMatchHotels');
...
Route::get('reservation/board', 'FrontEnd\ReservationController@suiteBoard');
Route::post('reservation/board', 'FrontEnd\ReservationController@storeSuiteBoard')->name('store.suiteboard');
