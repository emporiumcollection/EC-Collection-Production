...
//echo $finalQry; die;
    ...
    */
    ...
    public function getProperty($slug){
        ...
        $this->data['fac'] = \DB::table('tb_booking_hotel_facilities')->where('property_id', $this->data['hotel_data'][0]->id)->get();
...
//print_r($cateObj); die;
    ...
    public function propertysearchlistbycollection_03072021(Request $request){
        $coll_type = $request->input('coll_type');
        $cat = $request->input('cat');
