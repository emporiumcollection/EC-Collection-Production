...
trait Property {
    ...
    public function getPropertyByslug($slug){
        $property = properties::select([
            ...
            'youtube_channel',
            'architecture_title',
            'architecture_desciription',
            'architecture_portraite_image1',
            'architecture_portraite_image2',
            'architecture_portraite_image3',
            'architecture_portraite_image4',
            'architecture_landscape_image1',
            'architecture_landscape_image2',
            'architecture_sub_title',
            'architecture_sub_desciription',
            'architecture_landscapehovertext_image1',
            'architecture_landscapehovertext_image2',
            'architecture_image',
            'architecture_image2',
            'architecture_design_title',
            'architecture_design_desciription',
            'architecture_design_image',
    ...
    public function getSuitePrice($suite_id){
        ...
        $price = PropertyRoomPrices::select(['rack_rate', 'season_id'])
        //->whereIn('category_id', $roomIds) for amadeus
