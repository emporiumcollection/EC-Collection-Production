<header>
    ...
    <div class="top-header-inner">
      <div class="row align-items-center">
              ...
              <div class="filter-lst expand filter-guest filter-white">
                <div class="input-group">
                  <div class="gust-dropdown">
                    <div class="guest-option rto" data-toggle="tooltip" title="Change guest"><span
                        class="guest-count">2</span> Guest</div>
                  </div>
                </div>
              </div>
            </a>
        ...
        <div class="col-md-5 col-4 text-right mobile-flex">
          <a href="register.html" class="login-nav" data-toggle="tooltip" title="Login, Register or go to dashboard">
            <div class="user-profile-img">
              <img src="{{ asset('/images/user-icon-emporium-collection.svg')}}" alt="">
    ...
    <div class="menu-s">
      <div class="d-flex align-items-center">
        <ul class="nav nav-left mobile-off">
          <li class="nav-item">
            <a class="nav-link btn-sidebar" href="#" data-sidebar="#filterbar">
              <i class="ico ico-mixer" data-toggle="tooltip" title="Refine your search"></i>
            </a>
          </li>
          <li class="nav-item">
            <a class="nav-link" href="location-page.html">
              <i class="ico ico-place" data-toggle="tooltip" title="Switch to hotel list view"></i>
            </a>
          </li>
          <li class="nav-item">
            <a class="nav-link" href="#">
              <i class="ico ico-video" data-toggle="tooltip"
                title="Watch video inspirations for your chosen destination"></i>
            </a>
          </li>
          <!-- <li class="nav-item">
            <a class="nav-link" href="#">
        ...
        <ul class="nav nav-text mobile-off">
          <li class="nav-item">
            <a class="nav-link dropdown-toggle" href="#destination-menu" data-toggle="collapse">
              <span data-toggle="tooltip"
                title="Find a different experience for your chosen destination">Destinations</span>
            </a>
          </li>
          <li class="nav-item dropdown">
            ...
            <div class="dropdown-menu" aria-labelledby="navbarDropdown">
              <a href="#" class="dropdown-item">Design Hotels</a>
              <a href="#" class="dropdown-item">Boutique Hotels</a>
              <a href="#" class="dropdown-item">Spa and Wellness Hotels</a>
              <a href="#" class="dropdown-item">Cullinary Delights</a>
            </div>
          </li>
          <li class="nav-item dropdown">
            <a class="nav-link dropdown-toggle" href="#" id="navbarDropdown" role="button" data-toggle="dropdown"
              aria-haspopup="true" aria-expanded="false">
              <span data-toggle="tooltip" title="Select atmosphere of choice">Atmosphere</span>
            </a>
            <div class="dropdown-menu" aria-labelledby="navbarDropdown">
          ...
          <li class="nav-item dropdown">
            <a class="nav-link dropdown-toggle" href="#" id="navbarDropdown" role="button" data-toggle="dropdown"
              aria-haspopup="true" aria-expanded="false">
              <span data-toggle="tooltip" title="Select Facilities of choice">Facilities</span>
            </a>
            <div class="dropdown-menu" aria-labelledby="navbarDropdown">
              <div class="dropdown-inner filter-checkbox">
                @if(isset($facilities))
          ...
          <li class="nav-item dropdown">
            <a class="nav-link dropdown-toggle" href="#" id="navbarDropdown" role="button" data-toggle="dropdown"
              aria-haspopup="true" aria-expanded="false">
              <span data-toggle="tooltip" title="Select Style of choice">Style</span>
            </a>
            <div class="dropdown-menu" aria-labelledby="navbarDropdown">
              <div class="dropdown-inner filter-checkbox">
                @if(isset($style))
          ...
          <li class="nav-item dropdown">
            <a class="nav-link dropdown-toggle" href="#" id="navbarDropdown" role="button" data-toggle="dropdown"
              aria-haspopup="true" aria-expanded="false">
              <span data-toggle="tooltip" title="Select price range">Price</span>
            </a>
            <div class="dropdown-menu" aria-labelledby="navbarDropdown">
              <div class="dropdown-inner filter-checkbox">
                <div class="custom-control custom-checkbox">
        ...
        <ul class="nav nav-right ml-auto">
          <li class="nav-item">
            <a class="nav-link btn-sidebar" href="#" data-sidebar="#searchHistory">
              <i class="ico ico-layer" data-toggle="tooltip" title="Step back in time"></i>
            </a>
          </li>
          <li class="nav-item">
            <a class="nav-link btn-sidebar" href="#" data-sidebar="#question">
              <i class="ico ico-convertation" data-toggle="tooltip"
                title="Start a conversation with a Lifestyle Agent."></i>
            </a>
          </li>
          <li class="nav-item">
            <a class="nav-link btn-sidebar" href="#" data-sidebar="#share">
              <i class="ico ico-share-2" data-toggle="tooltip" title="Share my experience"></i>
            </a>
          </li>
          <li class="nav-item dropdown">
            <a class="nav-link" href="#" id="navbarDropdown" role="button" data-toggle="dropdown" aria-haspopup="true"
              aria-expanded="false">
              <i class="ico ico-diamon" data-toggle="tooltip" title="Add to my Collection"></i>
            </a>
  ...
  <div class="second-header">
    <div class="px-4 py-3">
      <div class="row">
        <div class="col-md-4 second-header-left">
          <div class="d-flex align-items-center mb-2 mobile-off">
        ...
        <div class="col-lg-8 pl-5 second-header-right">
          <div class="d-flex align-items-center">
            <div id="menunav">
  ...
  <div class="menunav-group">
                ...
                <div class="flexible-month row m-0 justify-content-center align-items-center">
                  <div class="monthselect">
                    ...
                    <label class="custom-control-label" for="july">
                      <img src="{{ asset('/images/calendarmonth.jpg')}}" width="30" alt="">
                      <p>July</p>
                    </label>
                  </div>
                  <div class="monthselect">
            ...
            <div class="col-7 col-lk--0991 ">
              <div class="inner-wrapper hotel-page-list suite-ontouch no-opacity">
                <div class="img-offset-slide ">
                  <div>
                    <a href="suite.html">
                      <img src="{{ asset('/images/97678356576-24898814906.jpg')}}" class="img-fluid" alt="">
                    </a>
                  </div>
                  <div>
                    <a href="suite.html">
    ...
    <p class="current-destination"><b>Current Destination : New York</b></p>
    <div class="tab-content">
        <!-- Europe tab content -->
                                            ...
                                            <div class="row h-100">
                                                <div class="col-3 col--819281 br-001 ">
                                                    <div class="destination-img">
                                                        <img src="{{ asset('/images/Emporium-Collection_129.jpg')}}" class="img-fluid"
                                                            alt="">
                                                    ...
                                                    <div class="row h-100">
                                                        ...
                                                        <div class="col-4 col--9819281">
                                                            <a href="#destinationSection" data-scroll>
                                                                <div class="destination-img">
                                                                    <img src="{{ asset('/images/e8150591299245.5e2eb7c1e4d56.jpg')}}"
                                                                        class="img-fluid" alt="">
                                                                    <div class="destinatios-cntay--00">
                                                        ...
                                                        <div class="col-4 col--9819281">
                                                            <div class="tab-content">
                                                                <div class="tab-pane fade show active" id="klagen">
                                                                    <div class="destination-img">
                                                                        <img src="{{ asset('/images/53511811337-49267444221.jpg')}}"
                                                                            class="img-fluid" alt="">
                                                                        <div class="destinatios-cntay--00">
                                                                            <p class="mb-0">
                                                                                Klagenfurt</p>
                                                                ...
                                                                <div class="tab-pane fade" id="sankt">
                                                                    <div class="destination-img">
                                                                        <img src="{{ asset('/images/97678356576-24898814906.jpg')}}"
                                                                            class="img-fluid" alt="">
                                                                        <div class="destinatios-cntay--00">
                                                                            <p class="mb-0">Sankt
                                                                            </p>
                    ...
                    <div class="tab-pane fade show active" id="designH">
                        <div class="row">
                            <div class="col-lg-4 mb-4 col-md-7">
                                <a href="#"><img src="{{ asset('/images/Emporium-Collection_129.jpg')}}" class="img-fluid" alt=""></a>
                            </div>
