...
<body>
    <div class="d-flex flex-column flex-root h-100">
        <div class="error error-3 d-flex flex-row-fluid bgi-size-cover bgi-position-center"
            style="background: url(../themes/EC/images/bg3.jpg);">
            <div class="px-10 px-md-30 py-10 py-md-0 d-flex flex-column justify-content-md-center">
                ...
                <p class="error-desc-2">How did you get here</p>
                <p class="font-size-h1 font-weight-bold text-dark-75">Sorry we can't seem to find the page you're
                    looking for.</p>
