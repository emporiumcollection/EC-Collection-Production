...
<div class="sbox animated fadeInRight">
	...
	<div class="sbox-content"> 	
		 ...
		 {!! Form::open(array('url'=>'surroundings/save?return='.$return, 'class'=>'form-horizontal','files' => true , 'parsley-validate'=>'','novalidate'=>' ')) !!}
<div class="col-md-12">
						<fieldset><legend> Surroundings</legend>
								  ...
								  <div class="form-group  " >
									<label for="Info" class=" control-label col-md-4 text-left"> Info </label>
									<div class="col-md-6">
									  {!! Form::text('info', $row['info'],array('class'=>'form-control', 'placeholder'=>'',   )) !!} 
									 </div> 
									 <div class="col-md-2">
			...
			<div style="clear:both"></div>	
				  ...
				  <div class="form-group">
					...
					<button type="button" onclick="location.href='{{ URL::to('surroundings?return='.$return) }}' " class="btn btn-success btn-sm "><i class="fa  fa-arrow-circle-left "></i>  {{ Lang::get('core.sb_cancel') }} </button>
					</div>	  
