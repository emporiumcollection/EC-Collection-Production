              ...
              <div class="dashboard-slider">
                <div>
                  <a href="/dashboard">
                    <div class="dashboard-slider-item">
                      <img src="{{ asset('uploads/slider_images/1568213046-24002805.jpg')}}"
                        class="w-100" alt="">
                ...
                <div>
                  <a href="{{ URL::to('/users/profile')}}">
                    <div class="dashboard-slider-item">
                      <img src="{{ asset('uploads/slider_images/1568268146-96506761.jpg')}}"
                        class="w-100" alt="">
                      <div class="slider-title">
                        My Profile
                      </div>
                ...
                <div>
                  <a href="reservations.html">
                    <div class="dashboard-slider-item">
                      <img src="{{ asset('uploads/slider_images/1568268487-93942589.jpg')}}"
                        class="w-100" alt="">
                      <div class="slider-title">
                        My Reservations
                      </div>
                ...
                <div>
                  <a href="{{ URL::to('/users/guestinvite')}}">
                    <div class="dashboard-slider-item">
                      <img src="{{ asset('uploads/slider_images/1568269053-45751192.jpg')}}"
                        class="w-100" alt="">
                      <div class="slider-title">
                        Invite Friends
                      </div>
                ...
                <div>
                  <a href="{{ URL::to('/users/setting')}}">
                    <div class="dashboard-slider-item">
                      <img src="{{ asset('uploads/slider_images/1568270092-66288025.jpg')}}"
                        class="w-100" alt="">
                      <div class="slider-title">
                        My Settings
                      </div>
                ...
                <div>
                  <a href="security-privacy.html">
                    <div class="dashboard-slider-item">
                      <img src="{{ asset('uploads/slider_images/1568270328-17372868.jpg')}}"
                        class="w-100" alt="">
                      <div class="slider-title">
                        My Security & Privacy
                      </div>
                ...
                <div>
                  <a href="{{ URL::to('/users/my-preferences')}}">
                    <div class="dashboard-slider-item">
                      <img src="{{ asset('uploads/slider_images/1568270655-22658407.jpg')}}"
                        class="w-100" alt="">
                      <div class="slider-title">
                        My Preferences
                      </div>
