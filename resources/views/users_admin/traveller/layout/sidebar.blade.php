...
<div class="aside-primary d-flex flex-column align-items-center flex-row-auto">
    ...
    <div class="aside-brand d-flex flex-column align-items-center flex-column-auto py-5 py-lg-12">
        <!--begin::Logo-->
        <a href="index.html">
            <img alt="Logo" src="{{ asset('assets/users/assets/media/logo.png')}}" width="60" />
        </a>
        <!--end::Logo-->
    </div>
    <!--end::Brand-->
    ...
    <div class="aside-nav d-flex flex-column align-items-center flex-column-fluid py-5 scroll scroll-pull">
        ...
        <ul class="nav flex-column">
            ...
            <li class="nav-item mb-3 " data-toggle="tooltip" data-placement="right" data-container="body"
                ...
                <a href="{{ URL::to('/dashboard')}}" class="nav-link btn btn-icon btn-clean btn-lg">
            ...
            <li class="nav-item mb-3 " data-toggle="tooltip" data-placement="right" data-container="body"
                ...
                <a href="{{ URL::to('/users/reservation')}}" class="nav-link btn btn-icon btn-clean btn-lg">
