        ...
        <div class="card card-custom card-stretch gutter-b">
            ...
            <div class="card-header h-auto border-0">
                <div class="card-title py-5">
                    <h3 class="card-label">
                        <span class="d-block text-dark font-weight-bolder">Revenue by Suite</span>
                        ...
                        <div class="bg-light-warning p-8 rounded-xl flex-grow-1">
                            ...
                            <div class="d-flex align-items-center mb-5">
                                ...
                                <div>
                                    ...
                                    <div class="font-size-sm text-muted">Suite Name</div>
                                </div>
                            </div>
                            <!--end::Item-->
                            <!--begin::Item-->
                            ...
                            <div class="d-flex align-items-center">
                                ...
                                <div>
                                    ...
                                    <div class="font-size-sm text-muted">Suite Names</div>
                                </div>
                            </div>
                            <!--end::Item-->
                        </div>
    ...
    <div class="col-lg-6 mb-7">
        ...
        <div class="card card-custom card-stretch gutter-b">
            ...
            <div class="card-header h-auto border-0">
                <div class="card-title py-5">
                    <h3 class="card-label">
                        <span class="d-block text-dark font-weight-bolder">Overall Revenue</span>
                        <span class="d-block text-muted mt-2 font-size-sm">More than 500+ new orders</span>
                    </h3>
                </div>
                <div class="card-toolbar">
