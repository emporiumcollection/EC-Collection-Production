...
@section('content')
	...
	<div id="kt_header_mobile" class="header-mobile">
		<!--begin::Logo-->
		<a href="hotels.html">
			ddf<img alt="Logo" src="../users/assets/media/logos/logo-letter-2.png" class="logo-default max-h-30px" />
		</a>
		<!--end::Logo-->
		<!--begin::Toolbar-->
					...
					<div class="card card-custom">
						<div class="card-header flex-wrap border-0 pt-6 pb-0">
							<div class="card-title">
								<h2 class="text-dark font-weight-bold font-saol">My Companions </h2>
							</div>
						...
						<div class="card-body">
							<div class="banner-page">
								...
								<h2 class="banner-title">My Companions </h2>
							</div>
							<div class="mt-15">
