...
<div class="sidebar-main pt-4 " id="gallery">
    ...
    <div class="nav-gallery-wrapper">
        ...
        <ul class="nav nav-tab-main nav-pills nav-justified mb-2">
            <li class="nav-item">
                <a class="nav-link active" href="#hotel_gallery" id="hotel_gallery-tab" data-toggle="tab" role="tab" aria-controls="hotel_gallery"
                aria-selected="true">
                    Hotel
                </a>
            </li>
            <li class="nav-item">
                <a class="nav-link" href="#restaurant_gallery" id="restaurant_gallery-tab" data-toggle="tab" role="tab" aria-controls="restaurant_gallery"
                aria-selected="false">
                    Restaurant
                </a>
            </li>
            <li class="nav-item">
                <a class="nav-link" href="#bars_gallery" id="bars_gallery-tab" data-toggle="tab" role="tab" aria-controls="bars_gallery"
                aria-selected="false">
                    Bars
                </a>
            </li>
            <li class="nav-item">
                <a class="nav-link" href="#experience_gallery" id="experience_gallery-tab" data-toggle="tab" role="tab" aria-controls="experience_gallery"
                aria-selected="false">
                    Experience
                </a>
            </li>
            <li class="nav-item">
                <a class="nav-link" href="#suite_gallery" id="suite_gallery-tab" data-toggle="tab" role="tab" aria-controls="suite_gallery"
                aria-selected="false">
                    Suites
                </a>
            </li>
                    ...
                    <div class="row justify-content-center">
                        <div class="col-8">
                            <div class="container-gallery" id="gallery_hotel">
                                <a class="tile" href="images/29be6592342279.5e49609509d85.jpg">
                                    <img src="images/29be6592342279.5e49609509d85.jpg" alt="">
                                </a>
                                <a class="tile" href="images/hotel-kjsdksd.jpg">
                                    <img src="images/hotel-kjsdksd.jpg" alt="">
                                </a>
                                <a class="tile" href="images/Gandhiva-Restaurant-7.jpg">
            ...
            <div class="sidebar-scroller pt-2 is-gallery">
                <div class="gallery-wrapper">
                    <div class="row justify-content-center">
                        ...
                        <div class="col-8">
                            <div class="container-gallery" id="gallery_experience">
                                <a class="tile" href="images/29be6592342279.5e49609509d85.jpg">
                                    <img src="images/29be6592342279.5e49609509d85.jpg" alt="">
                                </a>
                                <a class="tile" href="images/hotel-kjsdksd.jpg">
        ...
        <div class="row h-100">
            <div class="col-3">
                <ul class="nav flex-column nav-sidebar is-small" id="suitesside-tab" role="tablist"
                    ...
                    <li class="nav-item">
                        <a class="nav-link nav-link-sub" id="suitelist1-tab" data-toggle="pill" href="#suitelist1"
                            role="tab" aria-controls="suitelist1" aria-selected="false">Suite
                            Name</a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link nav-link-sub" id="suitelist1-tab" data-toggle="pill" href="#suitelist1"
                                        ...
                                        <div class="covid-info align-items-center">
                                            <div class="ico-security">
                                                <svg version="1.1" id="Capa_1" xmlns="http://www.w3.org/2000/svg"
                                                    ...
                                                    style="enable-background:new 0 0 214.27 214.27;" xml:space="preserve">
                                                    <g>
                ...
                c2.93-2.929,2.93-7.678,0.001-10.606C140.636,78.154,135.887,78.153,132.958,81.082z" />
                                        ...
                                        <div class="action-hotel">
                                            <nav class="nav nav-pills nav-justified">
                                                <a class="nav-link btn-sidebar" href="#"
                                                    data-sidebar="#suite-deal">Suite Deals</a>
                                                <a class="nav-link btn-sidebar" href="#"
                                ...
                                <div class="row">
                                    <div class="col-md-8">
                                        ...
                                        <h3 class="mb-4 color-dark-grey ">Suite Name</h3>
