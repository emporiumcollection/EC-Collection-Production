...
$level2TabTemplate = '<div class="tab-pane fade h-100 <!--LEVEL3-SHOWCLASS-->" id="<!--LEVEL3-CATALIAS-->">
                        <div class="row h-100">
                            <div class="col-3 col--819281 br-001 ">
                                ...
                                <a href="javascript:void(0);" onclick="filterDestination(\'<!--LEVEL3-NAME-->\')">   <button class="btn btn-primary" style="width:100%; margin-top:10px;">View <!--LEVEL3-NAME--> Collection</button>
                                </a>
                            </div>
                    ...
                    foreach($destinationMenu as $destination):
                        ...
                        foreach($destination['children'] as $level2){
                            ...
                            foreach($level2['children'] as $level3){
                                $destinationLevel3 .= '<a  onclick="HideDestination(\''.$level3['category_alias'].'\')" class="nav-link '.(in_array($level3['category_name'], $path) ? 'active' : '').'" href="#'.$level3['category_alias'].'" data-toggle="tab" role="tab">'.$level3['category_name'].'</a>';
