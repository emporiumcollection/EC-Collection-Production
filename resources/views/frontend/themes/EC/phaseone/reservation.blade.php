            ...
            <div class="row mb-5">
               <div class="col">
                  ...
                  <div class="form-group form-inline-group">
                     <input type="text" class="form-control form-line fromdate" placeholder="Select arrival date">
               ...
               <div class="guest-pick-container">
                  ...
                  <div class="guest-pick-body px-0">
                     ...
                     <div class="room-limit">
                        ...
                        <a href="#" class="btn btn-dark rounded-0 px-5"><i class="fa fa-phone"
                           aria-hidden="true"></i> REQUEST A CALL BACK</a>
                        <hr>
                  ...
                  <div class="guest-pick-footer px-0">
                  ...
                  <div class="col-lg-6">
                     <div class="suite-desc">
                        ...
                        <div class="row align-items-center mt-5">
                           ...
                           <div class="col-4">
                              <div class="text-right">
                                 <a href="#" class="btn btn-dark  px-4 select-sd rounded-0">Select</a>
                              </div>
                           </div>
                        </div>
                     </div>
...
<div id="step-4" class="tab-pane" role="tabpanel">
   <div class="row">
      <div class="col-lg-9 col-md-8">
         ...
         <div class="row">
            <div class="col-lg-9">
               <h4 class="mb-4">Special requirements <span class="small color-grey">(*Required)</span></h4>
