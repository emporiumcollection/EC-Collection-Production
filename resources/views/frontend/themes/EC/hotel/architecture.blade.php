                  ...
                  <div class="main-content">
                    ...
                    <div class="row mt-5">
                        ...
                        <div class="col-md-6">
                            ...
                            <h3 class="title-second title-line mb-0 font-3">Interior Design</h3>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="px-5 text-center mb-5">
                        <h3 class="mb-4">LOOP STAND WARDROPE / DESIGNER</h3>
                        <p class="px-5">
                        Think about New York of the 1980s with its large artwork, early hip hop, and punk rock scenes. Then
                        translate that vitality to a lodge on the Decrease East Aspect. Put collectively you get The Ludlow
                        Resort.
                    ...
                    <div class="user-profile mb-5">
                        <img src="{{ asset('images/profile_user.jpg')}}" class="img-fluid" alt="">
                        <p class="title-second title-line font-3 user-title">Interior Design</p>
                    </div>
                    <div class="px-5">
                        <img src="{{ asset('images/c52c5d91609529.5e36922fbff23.jpg')}}" class="img-fluid img-rounded" alt="">
                    </div>
                    <p class="py-5 px-15">
                      Think about New York of the 1980s with its large artwork, early hip hop, and punk rock scenes. Then
                      translate that vitality to a lodge on the Decrease East Aspect. Put collectively you get The Ludlow
