...
<div class="col-lg-6 col-md-6 mb-5 ">
  <div class="inner-wrapper hotel-page-list suite-ontouch no-opacity">
    ...
    <div class="pr-lst result-grid">
      ...
      ?>
        <div>
          <img <?php echo 'src="property-image/resize/615x419/'.$container_name.'/default-image.png/property-image"';?> <?php echo 'data-src="property-image/resize/900x600/'.$container_name.'/'.$file_name.'/property-image"';?> class="w-100 results-media" alt="">
        </div>
      <?php 
      endforeach;?>
    </div>
