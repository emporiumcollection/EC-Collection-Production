...
=======
      ...
      <div class="col-lg-9 content-lg">
        <div class="main-page-banner">
          <div class="img-main-banner">
            <div>
              <img src="uploads/category_imgs/<?php echo $location[0]['category_image']; ?>" class="img-fluid" alt="">
>>>>>>> f9390a9e3aed3b7c5a7bfbc80f2b6677a4f9a5c1
            </div>
            <div>
              <img src="https://www.emporium-voyage.com/uploads/slider_images/1517173449-45205782.jpg" class="img-fluid" alt="">
            </div>
          </div>
          ...
          <ul class="nav nav-tabs tabs-w3" id="myTab" role="tablist">
            <?php if (!empty($propertyResultsForView['lifestyle'])) : ?>
              <li class="nav-item" role="presentation">
                <a class="nav-link active" id="lifestyle-tab" data-toggle="tab" href="#lifestyle" role="tab" aria-controls="lifestyle" aria-selected="true">LIFESTYLE</a>
              </li>
            <?php endif; ?>
            <?php if (!empty($propertyResultsForView['dedicated'])) : ?>
              <li class="nav-item" role="presentation">
                <a class="nav-link" id="dedicated-tab" data-toggle="tab" href="#dedicated" role="tab" aria-controls="dedicated" aria-selected="false">DEDICATED</a>
              </li>
            <?php endif; ?>
            <?php if (!empty($propertyResultsForView['bespoke'])) : ?>
              <li class="nav-item" role="presentation">
                <a class="nav-link" id="bespoke-tab" data-toggle="tab" href="#bespoke" role="tab" aria-controls="bespoke" aria-selected="false">BESPOKE</a>
              </li>
            <?php endif; ?>
          </ul>
        </div>
