      ...
      <div class="row mt-5">
        <div class="col-lg-3 col-sm-3 position-relative">
          <div class="sidebar-nav-section">
            ...
            <div class="onstickmainpage2 onstick-width nav-collapse">
        ...
        <div class="col-lg-9 content-lg">
          ...
          <div class="title-main mb-5 ">
            <h2>{{ $keyword }} <a href="#searchF" data-toggle="collapse"><i class="ico ico-reload reload-offset"></i></a></h2>
      ...
      <div class="row">
        ...
        <div class="col-lg-9">
          ...
          <ul class="nav nav-tabs tabs-w3 collection-tabs" id="collection-tabs" role="tablist">
            ...
            <li class="nav-item dest-collection" role="presentation" data-name="{{$coll->category_alias}}">
              <a href="{{$coll->category_alias}}" class="nav-link <?php echo ($m_type==$coll->category_alias) ? 'active' : '' ?>" >{{$exp_cat_name[0]}}</a></li>
              {{--*/ $k++;  /*--}}
              @endforeach
            </ul>
            <div class="tab-content pt-5" id="myTabContent">
              <div class="tab-pane fade show active" id="lifestyle-collection" role="tabpanel" aria-labelledby="lifestyle-tab">
                <div class="row">
              ...
              <div class="tab-pane fade " id="dedicated-collection" role="tabpanel" aria-labelledby="dedicated-tab">
                <div class="row">
                  <div class="col-lg-6 col-md-6 mb-5 ">
                    <div class="inner-wrapper hotel-page-list suite-ontouch no-opacity">
                      <div class="pr-lst result-grid">
              ...
              <div class="tab-pane fade" id="bespoke-collection" role="tabpanel" aria-labelledby="bespoke-tab">
                <div class="row">
                  <div class="col-lg-6 col-md-6 mb-5 ">
                    <div class="inner-wrapper hotel-page-list suite-ontouch no-opacity">
                      <div class="pr-lst result-grid">
      ...
      <div class="sidebar-main" id="reviews">
        ...
        <div class="sidebar-scroller pt-2">
          ...
          <div class="row reviews">
            <div class="col-6 reviews-list" style="display: block;">
              <div class="row">
      ...
      <div class="sidebar-main" id="quickinfo">
        ...
        <div class="sidebar-scroller pt-2">
          <div class="d-flex align-items-center mb-5">
            ...
            <h3 class="title-second title-line mb-0" id="quickinfo_title">The Ludlow Hotel</h3>
          </div>
          <div class="row">
            <div class="col-8">
              ...
              <h4 class="mb-4" id="amenity_title">Amenities</h4>
