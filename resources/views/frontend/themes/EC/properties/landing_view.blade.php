...
{{--                              </a>--}}
                              ...
                              <a href="#" class="view bg-btn-gl-001 btn-sidebar" onclick="getHotelGallery({{$lh->id}})" data-sidebar="#gallery">
                                  Gallery
                              </a>
        ...
        $.ajax({
            ...
            success: function (data){
                if(data.status=='success'){
                    ...
                    html_hotel += '</div>';
                    html_hotel += '<h4 class="mb-4">Amenities</h4> <div class="row mb-5"> <div class="col-md-3 col-sm-6 mb-4"> <p class="mb-0">Pool</p> <p class="mb-0">Wlan</p> <p class="mb-0">Smart-TV</p> <p class="mb-0">Koffeemaschine</p> <p class="mb-0">Laundry service</p> </div> <div class="col-md-3 col-sm-6 mb-4"> <p class="mb-0">Pool</p><p class="mb-0">Wlan</p><p class="mb-0">Smart-TV</p><p class="mb-0">Kofmap2feemaschine</p><p class="mb-0">Laundry service</p></div><div class="col-md-3 col-sm-6 mb-4"><p class="mb-0">Pool</p><p class="mb-0">Wlan</p><p class="mb-0">Smart-TV</p><p class="mb-0">Koffeemaschine</p><p class="mb-0">Laundry service</p></div><div class="col-md-3 col-sm-6 mb-4"><p class="mb-0">Pool</p><p class="mb-0">Wlan</p><p class="mb-0">Smart-TV</p><p class="mb-0">Koffeemaschine</p><p class="mb-0">Laundry service</p></div></div>';

                    html_hotel += '<div class="row my-5">';
                    $(html_hotel.usp_service_ids).each(function(key, val){
                        html_hotel += '<div class="col text-center"><div class="i-touch"><p><i class="ico ico-covid"></i></p><p>'+val.title+'</p></div></div>';
                    });
                    html_hotel += '</div></div>';
                    // html_hotel += (hotel.corona_conscious == 1 ? '<div class="col text-center"><div class="i-touch"><p><i class="ico ico-covid"></i></p><p>Corona Conscious</p></div></div>' : '');
                    // html_hotel += (hotel.handpicked_collection == 1 ? '<div class="col text-center"><div class="i-touch"><p><i class="ico ico-hotel-line"></i></p><p>Handpicked Collection</p></div></div>' : '');
                    // html_hotel += (hotel.personalize_service == 1 ? '<div class="col text-center"><div class="i-touch"><p><i class="ico ico-bells"></i></p><p>Personalize Service</p></div></div>' : '');
                    // html_hotel += (hotel.perks_and_offers == 1 ? '<div class="col text-center"><div class="i-touch"><p><i class="ico ico-gift"></i></p><p>Perks & Offers</p></div></div>' : '');
                    // html_hotel += (hotel.price_matching == 1 ? '<div class="col text-center"><div class="i-touch"><p><i class="ico ico-shield"></i></p><p>Price Matching</p></div></div>' : '');
                    // html_hotel += (hotel.trusted_by_visa == 1 ? '<div class="col text-center"><div class="i-touch"><p><i class="ico ico-pay"></i></p><p>Trusted by Visa</p></div></div>' : '');
                    // html_hotel += (hotel.secure_booking == 1 ? '<div class="col text-center"><div class="i-touch"><p><i class="ico ico-lock"></i></p><p>Secure Booking</p></div></div></div></div>' : '');
