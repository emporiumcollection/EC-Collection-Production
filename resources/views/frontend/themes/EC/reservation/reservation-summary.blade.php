<div class="reservation-summary">
  ...
  <table class="table table-borderless mb-0">
    ...
    <tr>
      ...
      <td class="px-0 py-1 text-right">{{ \Session::get('selecte_arrive_date') ?: date('d-M-Y', \Session::get('arrival_date'))  
          }}</td>
    </tr>
    <tr>
      <td class="px-0 py-1">Check-out</td>
      <td class="px-0 py-1 text-right">{{ \Session::get('selecte_departure_date') ?: date('d-M-Y', \Session::get('departure_date')) 
         }}</td>
    </tr>
    <tr>
