							...
							<div class="col-lg-9 col-md-8 mb-4">
								<div class="row mt-5">
									<div class="col-md-12">
										<h2 class="mb-5 d-flex align-items-center"><a href="javascript:void(0);"
												class="backwizard btn-backwizard mobile-off"><i
													class="ico ico-back mr-3"></i></a> Your guest options include:</h2>
										<div class="filter-container-fl filter-container-mm" id="guest-pick"
											style="display: block;">
											<div class="guest-pick-container bg-white">
													...
													<div class="row align-items-center">
														...
														<div class="col-lg-3 col-md-5 col-5">
															<div class="row field-count-reservation align-items-center">
																<button type="button"
																	class="min-room {{ count($session_suites) <= 1 ? 'disable' : '' }}">-</button>
																<div class="col text-center">
																	<span class="mr-1 room-val">{{
																		\Session::has('total_suite') ?
																		\Session::get('total_suite') : 0 }}</span>
																	<input type="hidden" name="suite[]" id="suites"
																		class="suite"
																		value="{{ \Session::get('total_suite') }}" />
												...
												<div class="guest-pick-body px-0">
													...
													<div class="row list-eoom">
														...
														<div class="col-{{ count($session_suites) > 1 ? 6 : 12 }} col-ews mb-5"
															id="room-{{ ($key+1) }}">
															<p><b>Suite {{ ($key+1) }}</b></p>
															...
															<div class="row align-items-center py-2">
																...
																<div class="col-5">
																	<div
																		class="row field-count-reservation align-items-center">
																		<button type="button" class="min">-</button>
																		<div class="col text-center">
																			<span class="mr-1 adult-val">{{
																				$val['adult'] }}</span>
																			<input type="hidden" name="adult[]"
																				class="inp-adult" id="adult"
																				value="{{ $val['adult'] }}" />
																		</div>
																		<button type="button"
																			class="plus mr-3">+</button>
																	</div>
																</div>
															</div>
															<div class="row align-items-center py-2">
																	...
																	<div
																		...
																		<div class="col text-center">
																			<span class="mr-1 child-val">{{
																				$val['child'] }}</span>
																			<input type="hidden" name="child[]" id=""
																				class="inp-child"
																				value="{{ $val['child'] }}" />
																		</div>
																		<button type="button"
													...
													<div class="room-limit">
														...
														<p>Contact our Groups and Events team on 08989819281. and
															...
															<div class="col-4">
																...
																<div class="hotel-user">
																	<div class="pp-prof-det">
																		<img src="{{ asset('/images/img-profile.jpg')}}"
																			alt="">
																	</div>
																	<div class="usr-info">
																		<h4 class=" mb-2"><b>June</b> Davidson</h4>
																		<p class="dd--info mb-2">Luxury Lifstyle Agent
																		</p>
									...
									<div class="col-md-12 d-flex justify-content-between mt-4">
										<a href="/reservation/when/{{ \Session::get('property_id') }}"
											class="btn btn-dark px-5">Go back</a>
										<a href="javascript:void(0);"
											class="btn btn-dark px-5 availability-check select_guest_">Next</a>
									</div>
								</div>
							</div>
