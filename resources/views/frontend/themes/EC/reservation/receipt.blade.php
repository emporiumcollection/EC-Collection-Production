    ...
    <div class="aside-nav d-flex flex-column align-items-center flex-column-fluid py-5 scroll scroll-pull">
        ...
        <ul class="nav flex-column">
            ...
            <li class="nav-item mb-3 " data-toggle="tooltip" data-placement="right" data-container="body"
                ...
                <a href="/reservation/receipt" class="nav-link btn btn-icon btn-clean btn-lg active">
...
<!--end::Demo Panel-->
    <!--begin::Demo Panel-->
<div id="experience-popup" class="offcanvas offcanvas-sm offcanvas-experience offcanvas-right offcanvas-off p-10">
  <!--begin::Header-->
  <div class="offcanvas-header d-flex align-items-center justify-content-between pb-7">
