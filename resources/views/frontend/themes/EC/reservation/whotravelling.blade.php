    ...
    <div class="container-full ">
      <div id="smartwizard" class="wizard-reservation sw sw-theme-arrows sw-justified">
        ...
        <div class="pt-4 wizard-reservation-content">
          <div id="step-7" class="tab-pane pt-lg-5 pt-xl-5" role="tabpanel" style="display: block;">
              ...
              <div class="col-lg-9 col-md-8">
                <hr class="mb-4 mt-4">            
                  <div class="row mb-4 mt-5">
                    <div class="col-md-2">      
                      <h5><a href="javascript:void(0);" class="">My Address</a></h5>
                    </div>
                    <div class="col-md-1">      
                      <h5>or</h5>
                    </div>
                    <div class="col-md-3">
                      <h5><a href="javascript:void(0);" class="add_new_addres">Add new address</a></h5>      
                    </div>
                  </div>
