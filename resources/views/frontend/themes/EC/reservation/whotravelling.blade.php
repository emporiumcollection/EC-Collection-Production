        ...
        <div class="row">          
          <div class="col-lg-9 col-md-8">
            ...
            <div class="mt-13">
              <ul class="">
                <li class="nav-item">
                  <a href="" class="nav-link active" data-toggle="tab">My Address</a>
                </li>
                <li class="nav-item">
                  <a href="#addnewaddress" class="nav-link" data-toggle="tab">Add new Address</a>
                </li>
              </ul>
            </div>
          <div class="tab-content p-7 profile-tabs">
            <div class="tab-pane fade show active" id="myaddress">
            ...
            <div class="row">
              ...
              <div class="col-md-4 form-group">
                ...
                <input type="text" name="first_name" id="first_name" class="form-control"  value="{{ $address->first_name ? $data->first_name : ''}}">
              </div>
            </div>
            <div class="row">
              <div class="col-md-4 form-group">
                <label>Last name<sup>*</sup></label>
                <input type="text" name="last_name" id="last_name" class="form-control" value="{{ $address->last_name ? $data->last_name : ''}}">
              </div>
              <div class="col-md-4 form-group">
                <label>Email<sup>*</sup></label>
                <input type="text" name="email" id="email_" class="form-control" value="{{ $address->email ? $data->email : ''}}">
              </div>
            </div>
            <div class="row">
              <div class="col-md-4 form-group">
            ...
            <div class="row">
              <div class="col-md-4 form-group">
                ...
                <input type="text" name="address1" id="address1" class="form-control" value="{{ $address->address ? $data->address : ''}}">
              </div>
              <div class="col-md-4 form-group">
            ...
            <div class="row">
              <div class="col-md-4 form-group">
                ...
                <input type="text" name="city" id="city" class="form-control" value="{{ $address->city ? $data->city : ''}}">
              </div>
              <div class="col-md-4 form-group">
            ...
            <div class="row">
              <div class="col-md-4 form-group">
                ...
                <input type="text" name="zip_code" id="zip_code" class="form-control" value="{{ $address->zip_code ? $data->zip_code : ''}}">
              </div>                            
            </div>
          </div>

          <div class="tab-pane fade" id="addnewaddress">
            <div class="row">
              <div class="col-md-4 form-group">
                <label>Title<sup>*</sup></label>
                <select name="title" id="add_title" class="form-control ">
                  <option value="Mr">Mr</option>
                  <option value="Mrs">Mrs</option>
                  <option value="Miss">Miss</option>
                  <option value="Ms">Ms</option>
            ...
            <div class="row">
              <div class="col-md-4 form-group">
                <label>City/Town<sup>*</sup></label>
                <input type="text" name="add-city" id="add-city" class="form-control">
              </div>
              <div class="col-md-4 form-group">
                <label>County/State</label>
            ...
            <div class="row">
              <div class="col-md-4 form-group">
                <label>Zip/Post code<sup>*</sup></label>
                <input type="text" name="zip_code" id="add_zip_code" class="form-control">
              </div>                            
            </div>
          </div>
          </div>  
