                ...
                @foreach($cards as $card)
                    ...
                    <div class="col-lg-7 col-md-8">
                      <div class="d-flex align-items-center list-divider">
                        ...
                        <div class="d-flex flex-column flex-grow-1">
                          ...
                          <span class="text-muted font-weight-bold">Expiration: {{ $card->exp_month }} / {{
                            $card->exp_year }} </span>
                        </div>
                        <div class="mb-2"><input type="radio" name="card_id" value="{{ $card->id }}" {{ $last_id->id ==
                          $card->id ? 'checked' : '' }}> Use this card</div>
                        <!--end::Dropdown-->
                      </div>
                    </div>
                  </div>
                  ...
                  <div class="row align-items-center">
                    ...
                    <div class="col-md-4 form-group">
                      <select class="wide form-control card_type" name="card_type" id="card_type">
                  ...
                  <div class="row align-items-center">
                    ...
                    <div class="col-md-4 col-sm-8 form-group">
                      <input type="text" class="card_number credit" name="card_number" id="card_number"
                        placeholder="****_****_****_****">
                      <div class="invalid-feedback"></div>
                    </div>
                  </div>
                  ...
                  <div class="row">
                    <div class="col-lg-9">
                      ...
                      <div class="form-group">
                        <textarea class="form-control requirements" name="requirements" id="" cols="30" rows="10"
