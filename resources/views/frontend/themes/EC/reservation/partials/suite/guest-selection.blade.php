        ...
        <div class="row">
            ...
            <div class="col-md-12">
                <?php if(!empty(\Session::get('suite_array')) && array_key_exists(  $suite->id, \Session::get('suite_array'))){ ?>
                    ...
                    <a href="javascript:void(0);" class="btn btn-dark ml-lg-2 ml-xl-2 remove_suite" title="Remove" data-suite-id="{{ $suite->id }}" style="padding: 10px 9px;"><i class="fa fa-times-circle-o"></i></a>
                <?php }else{ ?>
