                            ...
                            <div class="row">
                                ...
                                <div class="col-lg-6">
                                    <div class="reservation-img mb-8">
                                        ...
                                        ?>                  
                                            <div>
                                                <img <?php echo 'src="property-image/resize/615x419/'.$container_name.'/default-image.png/property-image"';?> <?php echo 'data-src="property-image/resize/615x419/'.$container_name.'/'.$file_name.'/property-image"';?> class="w-100" alt="">
                                            </div>
                                        <?php endforeach; ?>    
                                        </div>
