...
<!-- buttons -->
    <div class="col-md-12">
        <div class="col-md-4 hidden-md hidden-lg col-xs-4 col-sm-4">
            <span class="hamburger-menu editorial-res-side-nav-logo hidden-md hidden-lg visible-xs visible-sm" onclick="openNav()"><img src="/sximo/assets/images/Hamburger-Menu_1.png" alt=""></span>
        </div>
