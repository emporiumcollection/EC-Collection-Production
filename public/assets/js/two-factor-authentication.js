        ...
        init: function () {
            (e = document.querySelector("#kt_modal_two_factor_authentication")) &&
                ...
                (l = FormValidation.formValidation(a, {
                    fields: { mobile: { validators: { notEmpty: { message: "Mobile no is required" } } } },
                    plugins: { trigger: new FormValidation.plugins.Trigger(), bootstrap: new FormValidation.plugins.Bootstrap({ rowSelector: ".fv-row", eleInvalidClass: "", eleValidClass: "" }) },
                })),
                ...
                (f = FormValidation.formValidation(c, {
                    fields: { code: { validators: { notEmpty: { message: "Code is required" } } } },
                    plugins: { trigger: new FormValidation.plugins.Trigger(), bootstrap: new FormValidation.plugins.Bootstrap({ rowSelector: ".fv-row", eleInvalidClass: "", eleValidClass: "" }) },
                })),
                                        ...
                                        ? (u.setAttribute("data-kt-indicator", "on"),
                                          ...
                                          setTimeout(function () {
                                              u.removeAttribute("data-kt-indicator"),
                                                  (u.disabled = !1),
                                                  Swal.fire({ text: "Code has been successfully submitted!", icon: "success", buttonsStyling: !1, confirmButtonText: "Ok, got it!", customClass: { confirmButton: "btn btn-primary" } }).then(
                                                      function (e) {
                                                          e.isConfirmed && (t.hide(), p());
                                                          $('#kt_modal_two_factor_authentication').modal('hide');
                                                      }
