	                                ...
	                                <ul class="navi flex-column navi-hover py-2">\
	                                    ...
	                                    <li class="navi-item">\
	                                        <a href="#detail" class="navi-link" data-canvas="popup">\
	                                            ...
	                                            <span class="navi-text">Edit Client</span>\
	                                        </a>\
	                                    </li>\
	                                    <li class="navi-item">\
	                                        <a href="#detail" class="navi-link" data-canvas="popup">\
												<span class="navi-icon"><i class="flaticon-delete"></i></span>\
	                                            <span class="navi-text">Delete Client</span>\
	                                        </a>\
	                                    </li>\
	                                    <li class="navi-item">\
	                                        <a href="#detail" class="navi-link" data-canvas="popup">\
												<span class="navi-icon"><i class="flaticon-chat-1"></i></span>\
	                                            <span class="navi-text">Send Message</span>\
	                                        </a>\
	                                    </li>\
	                                    <li class="navi-item">\
	                                        <a href="#detail" class="navi-link" data-canvas="popup">\
												<span class="navi-icon"><i class="flaticon-imac"></i></span>\
	                                            <span class="navi-text">View Preferences</span>\
	                                        </a>\
	                                    </li>\
	                                    ...
	                                    <li class="navi-item">\
											<a href="#chat" class="navi-link" data-canvas="popup">\
												<span class="navi-icon"><i class="flaticon-chat-1"></i></span>\
												<span class="navi-text">View Invoices</span>\
											</a>\
	                                    </li>\
										<li class="navi-item">\
