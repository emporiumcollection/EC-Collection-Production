			...
			columns: [
				{
					...
					field: 'AffiliateHotel',
					title: 'Affiliated Hotel',
					width: 170,
				}, {
					field: 'Email',
					title: 'Email',
				...
				},
				{
					...
					template: function() {
						return '\
							...
							<a href="#statistics" class="btn btn-sm btn-clean btn-icon mr-2" data-canvas="popup" title="Email">\
