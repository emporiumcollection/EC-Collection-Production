'use strict';
// Class definition
var KTDatatableChildDataLocalDemoGroup = function () {
	// Private functions
			...
			columns: [
				{
					...
					template: function () {
						...
						<div class="dropdown" data-toggle="tooltip" title="Quick actions" data-placement="left"> \
							...
							<a href="#editGroup" class="btn btn-sm btn-clean btn-icon mr-2" data-canvas="popup" title="Edit">\
...
jQuery(document).ready(function () {
	KTDatatableChildDataLocalDemoGroup.init();
	$('a[href="#group_crm"]').on('shown.bs.tab', function (e) {
		KTDatatableChildDataLocalDemoGroup.init();
