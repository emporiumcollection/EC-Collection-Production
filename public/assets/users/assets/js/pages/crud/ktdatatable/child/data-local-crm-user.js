'use strict';
// Class definition
var KTDatatableChildDataLocalDemoUser = function () {
	// Private functions
	...
	var mainTableInit = function () {
			...
			columns: [
				{
					...
					template: function () {
						...
						<div class="dropdown" data-toggle="tooltip" title="Quick actions" data-placement="left"> \
							...
							<a href="#editUser" class="btn btn-sm btn-clean btn-icon mr-2" data-canvas="popup" title="Edit">\
		...
		var modal = datatable.closest('.tab-content');
...
jQuery(document).ready(function () {
	$('a[href="#user_crm"]').on('shown.bs.tab', function (e) {
		KTDatatableChildDataLocalDemoUser.init();
	})
});
