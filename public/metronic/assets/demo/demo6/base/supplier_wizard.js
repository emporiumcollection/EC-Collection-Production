...
function wizard_step_2(){
    ...
    var base_url = $('#base_url').val();
    $.ajax({
        url:base_url+'/save_new_supplier_profile',
        type:'POST',
        dataType:'json',
        contentType: false,
        processData: false,
...
function wizard_step_3(){
    ...
    if($("input[name=accepted_commission_contracts]").is(":checked")){
        ...
        fdata.append("supplier_commission_type",$("input[name=supplier_commission_type]:checked").val());       
        var base_url = $('#base_url').val();
        $.ajax({
            url:base_url+'/suppliercommissiontype',
            type:'POST',
            dataType:'json',
            contentType: false,
            processData: false,
        	  ...
        	  success: function(data){
                ...
                }else
                {
                    ...
                    if(dwl_val==0){
                        ...
                        var commission_type = $("input[name=supplier_commission_type]:checked").val();
